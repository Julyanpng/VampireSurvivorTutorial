...
public class InventoryManager : MonoBehaviour
{
    ...
    public class PassiveItemUpgrade
    {
        ...
        public PassiveItemScribtableScript passiveItemData;
    }
    ...
    {
        if (IsValidSlot(slotIndex, weaponSlots.Count))
        {
    ...
    {
        if (IsValidSlot(slotIndex, passiveItemSlots.Count))
        {
        ...
        {
            Debug.LogWarning("Invalid passive item slot index: " + slotIndex);
        }
    }
    ...
    public void LevelUpWeapon(int slotIndex, int upgradeIndex)
    {
        if (IsValidSlot(slotIndex, weaponSlots.Count))
        {
            ...
            if (weapon == null || weapon.weaponData == null || weapon.weaponData.NextLevelPrefab == null)
            {
                Debug.LogError("NO NEXT LEVEL FOR " + (weapon ? weapon.name : "Weapon at slot " + slotIndex));
                return;
            }
            ...
            WeaponController newWeaponController = upgradedWeapon.GetComponent<WeaponController>();
            AddWeapon(slotIndex, newWeaponController);
    ...
    public void LevelUpPassiveItem(int slotIndex, int upgradeIndex)
    {
        if (IsValidSlot(slotIndex, passiveItemSlots.Count))
        {
            ...
            if (passiveItem == null || passiveItem.passiveItemData == null || passiveItem.passiveItemData.NextLevelPrefab == null)
            {
                Debug.LogError("NO NEXT LEVEL FOR " + (passiveItem ? passiveItem.name : "Passive item at slot " + slotIndex));
                return;
            }
            ...
            PassiveItem newPassiveItem = upgradedPassiveItem.GetComponent<PassiveItem>();
            AddPassiveItem(slotIndex, newPassiveItem);
    ...
    private bool IsValidSlot(int index, int max)
    {
